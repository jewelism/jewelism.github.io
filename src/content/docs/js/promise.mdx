...
import img from '../../../assets/images/promise-all-resolve.png';
import img2 from '../../../assets/images/promise-all-reject.png';
...
<img src={img.src} width={img.width} height={img.height} alt="promise all resolve" />
<img src={img2.src} width={img2.width} height={img2.height} alt="promise all reject" />
